...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a class="btn-getstarted" href="{{route('')}}}">Login</a>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <h2 data-aos="fade-up" data-aos-delay="100">Menabung hari ini,Untuk Masa Depan Yang Lebih Pasti</h2>
          </div>
        </div>
      </div>
    ...
    <section id="features" class="features section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Panduan Fitur</h2>
        <p>Disini akan menjelaskan bagaimana Pengguna akan Menggunakan Website ini, dan Mennjelaskan Beberapa fitur</p>
      ...
      <div class="container">
        ...
        <div class="row gy-4 align-items-stretch justify-content-between features-item ">
          ...
          <div class="col-lg-5 d-flex justify-content-center flex-column" data-aos="fade-up">
            ...
            <p>Jika Kamu sudah memiliki tabungan maka kamu bisa menarik uang tabunganmu kapan saja</p>
          </div>
        </div><!-- Features Item -->

        <div class="row gy-4 align-items-center features-item">
          <div class="col-lg-5 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <h3>3. Kamu juga dapat Melihat Riwayat Transaksimu</h3>
            <p>
