...
<head>
    ...
    <!-- my style -->
    <link rel="stylesheet" href="{{ asset('dashboard/dist/assets/css/mycss/kirimpesan.css') }}">
...
<body>
    <div id="app">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('contact') }}" class="sidebar-link" data-target="contact">
                                <i class="bi bi-envelope-fill"></i>
                                <span>Pesan</span>
                                @if (!Request::is('contact') && isset($unreadCount) && is_numeric($unreadCount) && $unreadCount > 0)
                                <span class="badge-notif">
                                    <h2 id="badge-count">{{ $unreadCount }}</h2>
                                </span>
                                @endif
                            </a>
                        </li>
        ...
        <div id="main">
            ...
            <form id="reportForm" class="report-form" action="{{ route('laporan.kirim') }}" method="POST">
                @csrf
                <header class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrapper">
                        <select id="kategori" name="kategori" class="form-control" style="cursor: pointer;">
                ...
                <div id="jenisLaporanDiv" class="form-group hidden">
                    <label for="jenisLaporan">Laporkan Masalah</label>
                    <div class="select-wrapper">
                        <select id="jenisLaporan" class="form-control" style="cursor: pointer;">
                            <option value="">Laporkan Masalah...</option>
