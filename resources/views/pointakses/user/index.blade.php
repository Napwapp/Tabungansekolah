            ...
            <div class="content" style="margin-left: 30px;">
                ...
                <div class="row my-4">
                    <div class="col-md-4 text-center">
                        <a href="{{route('plus')}}"><button class="btn-action btn-yellow"><img class="icon-btn" src="{{asset ('dashboard/dist/assets/images/icons/icons8-plus-50.png')}}" alt="">Tambah Saldo</button></a>
                    </div>
                    <div class="col-md-4 text-center">
                        <a href="{{route('menabung')}}"><button class="btn-action btn-green"> <img class="icon-btn" src="{{asset ('dashboard/dist/assets/images/icons/icons8-money-32.png')}}" alt="">Menabung</button></a>
                    </div>
                    <div class="col-md-4 text-center">
                        <a href="{{route('menarik')}}"><button class="btn-action btn-blue"> <img class="icon-btn" src="{{asset ('dashboard/dist/assets/images/icons/icons8-withdraw-money-32.png')}}" alt="">Tarik Tabungan</button></a>
                    </div>
                </div>
