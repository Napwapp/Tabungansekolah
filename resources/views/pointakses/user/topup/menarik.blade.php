            ...
            <form id="withdrawForm" action="{{ route('penarikan.store') }}" method="POST">
                ...
                <div class="deposit-form">
                    <div class="input-wrapper">
                        ...
                        <input id="amount" name="formatted_amount" type="text" placeholder="Jumlah Tabungan yang akan ditarik" required>
                ...
                <div class="button-wrapper">
                    <button type="button" class="deposit-button" id="submitWithdraw">Ajukan penarikan</button>
